package br.com.marques.kontaktapi.util;
...
public class HubspotApiHelper {
    ...
    public <R> Mono<R> executeCall(MultiValueMap<String, String> params, Class<R> responseType) {
    ...
    public String generateAuthorizationUrl(String scopes) {
